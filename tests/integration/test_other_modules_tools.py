...
@pytest.mark.asyncio
async def test_data_management_add_body_composition_date_tool(app_with_data_management, mock_garmin_client):
...
@pytest.mark.asyncio
async def test_data_management_add_body_composition_timestamp_tool(app_with_data_management, mock_garmin_client):
    """Test add_body_composition accepts timestamp for scale measurements"""
